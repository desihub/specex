#ifndef SPECEX_DISK_MOFFAT_PSF__H
#define SPECEX_DISK_MOFFAT_PSF__H
...
namespace specex {
  ...
  class DiskMoffatPSF : public PSF {
  ...
  public :
    ...
    DiskMoffatPSF(int ideg=3);
    virtual ~DiskMoffatPSF(){}; 
  ...
  BOOST_SERIALIZATION_SHARED_PTR(DiskMoffatPSF)
