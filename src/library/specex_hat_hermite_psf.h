#ifndef SPECEX_HAT_HERMITE_PSF__H
#define SPECEX_HAT_HERMITE_PSF__H
...
namespace specex {
  ...
  class HatHermitePSF : public PSF {
  ...
  public :
    ...
    HatHermitePSF(int ideg=3);
    virtual ~HatHermitePSF(){}; 
  ...
  BOOST_SERIALIZATION_SHARED_PTR(HatHermitePSF)
