...
def run_comparison():
    ...
    t0 = time.time()
    # For initial parity, only fit flux. 
    # Non-linear Legendre fitting will be integrated in PSF_Fitter.fit.
    final_chi2 = fitter.fit(image, weight, spots, bundle_id, fit_type='flux')
    t1 = time.time()
