...
### Still open / good next-session leads (additions)
- **The residual ~0.138px yrms discrepancy (forced-identical-spots, r2@20250109 bundle 0) is still unexplained** -- footprint pixel-count ruled out as the cause tonight. Next lead: per-iteration chi2/gradient comparison between the two pipelines on this exact forced-spots input (same suggestion as two sessions ago, now on firmer ground since the footprint red herring is cleared).
